...
from bokeh.models.widgets import RangeSlider, TextInput, CheckboxGroup
...
def plot_data(filename, cwd):
    ...
    checkbox_group = CheckboxGroup(labels=["a_x", "a_y", "a_z"], active=[0, 1, 2])
    ...
    my_widgets = row(checkbox_group, column(row(text_start, text_end), range_slider))
